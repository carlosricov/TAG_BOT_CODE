...
def FindTAGBot(image, hsv):
    ...
    # Pink bag in 119 with 25% lighting
    # TAGBotLow = np.array([125, 0, 247], np.uint8)
    # TAGBotHigh = np.array([168, 138, 255], np.uint8)

    # Pink bag in 202 with left side
    # TAGBotLow = np.array([0, 91, 186], np.uint8)
    # TAGBotHigh = np.array([23, 250, 255], np.uint8)

    # Pink bag in 202 with left side with shade
    TAGBotLow = np.array([150, 102, 90], np.uint8)
    TAGBotHigh = np.array([179, 184, 245], np.uint8)
